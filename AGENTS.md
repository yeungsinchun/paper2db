...
- Generated artifacts under `intermediate/`, `tests/reconstructed/`, `classified/`, and `.lavish/` are gitignored: regenerate with `./pipeline`; README "Regenerating" lists the tracked inputs. Never commit generated crops, PDFs, or review HTML.
